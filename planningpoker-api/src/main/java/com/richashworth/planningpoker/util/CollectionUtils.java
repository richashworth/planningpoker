...
public class CollectionUtils {
  ...
  public static boolean containsIgnoreCase(
      final Collection<String> collection, final String matching) {
    return collection.stream().anyMatch(input -> input.equalsIgnoreCase(matching));
  }

  public static boolean containsUserEstimate(
      final Collection<Estimate> estimates, final String userName) {
