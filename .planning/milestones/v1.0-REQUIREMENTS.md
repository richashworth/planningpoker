# Requirements Archive: v1.0 Estimation Schemes
...
- [x] **SCHM-05**: Scheme is locked for the session duration

### API & State

- [x] **API-01**: createSession accepts scheme parameters and returns JSON with scheme metadata
- [x] **API-02**: joinSession returns scheme metadata so joiners see correct cards
- [x] **API-03**: Server validates votes against the session's scheme (not hardcoded set)
...
- [x] **UI-06**: Redux state stores scheme info from create/join responses
